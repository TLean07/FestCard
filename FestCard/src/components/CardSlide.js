...
import { addOutline, arrowRedoOutline, cashOutline } from "ionicons/icons";
        ...
        <>
            ...
            <IonRow className="ion-text-center">
                <IonCol size="12">
                    ...
                    {}
                    <IonButton className={ styles.addButton } size="small" style={{ "--background": card.color, "--background-focused": card.color, "--background-hover": card.color, "--background-activated": card.color }} onClick={handleNfcPayment}>
                ...
                <IonRow id={ `slide_${ index }_transactions` } className="animate__animated">
                    <IonCol size="12">
                        <IonList className={ styles.transactionList }>
                            { card.transactions.length > 0 && card.transactions.slice(0).reverse().map((transaction, index) => (
